...
@purchases_bp.route("/completed-purchase/<string:purchase_id>", methods=["GET"])
@jwt_required()
...
@purchases_bp.route("/completed-sale/<string:purchase_id>", methods=["GET"])
@jwt_required()
def get_completed_sale(purchase_id: str) -> tuple[Response, int]:
    """
    Retrieve a completed sale for the authenticated user.
    ...
    Possible errors:
        ...
        500 if an unexpected error occurs
    """
    return PurchasesController.get_completed_sale_controller(purchase_id)
