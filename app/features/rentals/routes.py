...
def get_my_completed_rentals() -> tuple[Response, int]:
    """
    Retrieve all completed rentals for the authenticated user.
...
@jwt_required()
def get_my_completed_lendings() -> tuple[Response, int]:
    """
    Retrieve all completed lendings for the authenticated user.
