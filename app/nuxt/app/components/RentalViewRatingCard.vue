...
import { useCompletedRentalRating } from '~/composables/useCompletedRentalRating';
...
const { getCompletedRentalRatings, loading } = useCompletedRentalRating();
...
onMounted(async () => {
  const data = await getCompletedRentalRatings(props.rentalId);
